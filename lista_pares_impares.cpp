...
int main(){
    ...
    int n;
    cout<<"Cuantos elementos desea que le despliegue la lista? "<<endl;
    cin>>n;
    int random;
    srand(time(NULL));
    for(int i=0;i<n;i++){
    ...
    cout<<"La lista con los numeros pares es: "<<endl;
    mostrarP(InicioP);
    cout<<"La lista con los numeros impares es: "<<endl;
    mostrarI(InicioI);
    cout<<"La lista ya vacia: "<<endl;
    mostrar(Inicio);
